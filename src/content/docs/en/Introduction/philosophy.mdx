...
Now that you understand the philosophy, let’s get your first Zuno project running. Head over to [Getting Started](/en/introduction/getting-started) to begin.
