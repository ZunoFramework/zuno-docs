...
- Add [Brotli Compression](/extensions/compression) for faster delivery
- Secure with [TLS](/guide/tls-security)
- Combine with [Authenticated Routes](/examples/authenticated-endpoint)
