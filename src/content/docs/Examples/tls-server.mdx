...
- Add [CORS](/extensions/cors) and [Rate Limiting](/extensions/rate-limiting)
- Serve [Static Files](/extensions/static-files) over HTTPS
- Explore [Advanced Configuration](/reference/advanced-config)
