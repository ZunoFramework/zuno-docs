...
- [Middleware](/guide/middleware) like logging or authentication
- [Rate Limiting](/extensions/rate-limiting) to protect endpoints
- [TLS Support](/guide/tls-security) for secure APIs
