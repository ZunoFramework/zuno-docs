...
<LinkButton href="/getting-started" icon="rocket" variant="primary">Get Started</LinkButton>
...
- [🚀 Quickstart Guide](/getting-started) — Launch your first Zuno app in minutes.
...
<LinkButton href="/docs/getting-started" icon="rocket" variant="primary">Start with Zuno</LinkButton>
